...
/*					String[] handlerParams = (triggerParam.getExecutorParams()!=null && triggerParam.getExecutorParams().trim().length()>0)
					...
					handlerParams[1] = (triggerParam.getExecutorParams2()!=null && triggerParam.getExecutorParams2().trim().length()>0)
							? triggerParam.getExecutorParams2() : null;*/

					String executorParams = (triggerParam.getExecutorParams()!=null && triggerParam.getExecutorParams().trim().length()>0)
							? triggerParam.getExecutorParams() : null;
					String middlePrefix = "-";
					String executorParams2 = (triggerParam.getExecutorParams2()!=null && triggerParam.getExecutorParams2().trim().length()>0)
							? triggerParam.getExecutorParams2() : null;
							
					String[] handlerParams = (executorParams+middlePrefix+executorParams2).split("-");
