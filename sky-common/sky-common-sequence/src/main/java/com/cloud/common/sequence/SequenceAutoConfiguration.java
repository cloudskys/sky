package com.cloud.common.sequence;

import com.cloud.common.sequence.builder.DbSeqBuilder;
import com.cloud.common.sequence.builder.RedisSeqBuilder;
import com.cloud.common.sequence.builder.SnowflakeSeqBuilder;
import com.cloud.common.sequence.properties.SequenceDbProperties;
import com.cloud.common.sequence.properties.SequenceRedisProperties;
import com.cloud.common.sequence.properties.SequenceSnowflakeProperties;
import com.cloud.common.sequence.range.impl.name.DateBizName;
import com.cloud.common.sequence.range.impl.name.DefaultBizName;
 ...
 */
@Configuration
@ComponentScan("com.cloud.common.sequence")
